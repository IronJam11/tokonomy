...
export default function ChatbotPage() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      text: "Hi! I'm your TokenBot Prompt. I can create cryptocurrency tokens from any idea, concept, or prompt you give me! Whether it's about places like Hawaii, trending topics, foods, activities, or completely original ideas - I'll transform it into a viral-worthy token with full analysis and market predictions. What would you like me to create a token for today?",
      isUser: false,
      timestamp: new Date()
    }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      const response = await fetch('/api/promptbot', {
        method: 'POST',
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="font-semibold text-gray-900 dark:text-white text-lg">Tokebot Prompt</h1>
